...
function renderCard(a, idx, isActive) {
  ...
  return '<div class="card' + (isActive ? ' active' : '') + (!isOnline ? ' offline' : '') + '" onclick="toggleExpand(' + a.agent.id + ')" data-id="' + a.agent.id + '">'
    ...
    + '</div>'
    + '<div class="card-traffic" data-traffic-id="' + a.agent.id + '"><span class="traffic-label">TRAFFIC</span><span class="traffic-down">\u2193 —</span><span class="traffic-divider">/</span><span class="traffic-up">\u2191 —</span></div>'
    + pingHtml
...
function renderListRow(a, idx, isActive) {
  ...
  return '<div class="list-row' + (isActive ? ' active' : '') + ' ' + (!isOnline ? 'offline' : '') + '" onclick="toggleExpand(' + a.agent.id + ')" data-id="' + a.agent.id + '">'
    ...
    + '</div>'
    + '<span class="list-traffic" data-traffic-id="' + a.agent.id + '"><span class="traffic-label">TRAFFIC</span><span class="traffic-down">\u2193 \u2014</span><span class="traffic-divider">/</span><span class="traffic-up">\u2191 \u2014</span></span>'
...
function updateTrafficDisplay(id, data) {
  ...
  if (el) {
    el.innerHTML = '<span class="traffic-label">TRAFFIC</span><span class="traffic-down">\u2193 ' + recvStr + '</span><span class="traffic-divider">/</span><span class="traffic-up">\u2191 ' + sentStr + '</span>';
  }
}
